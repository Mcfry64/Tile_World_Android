...
OSHW_EXTERN int setsfxmsg(char const *msg, int msecs, int bold);
...
/* Return TRUE if the sound effect for the given index is loaded in memory.
 */
OSHW_EXTERN int sfx_loaded(int index);
