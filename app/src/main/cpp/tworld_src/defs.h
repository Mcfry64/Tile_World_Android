...
#define	SND_KEY_COLLECTED	18

#define	SND_ONESHOT_COUNT	19

#define	SND_BLOCK_MOVING	19
#define	SND_SKATING_FORWARD	20
#define	SND_SKATING_TURN	21
#define	SND_SLIDING		22
#define	SND_SLIDEWALKING	23
#define	SND_ICEWALKING		24
#define	SND_WATERWALKING	25
#define	SND_FIREWALKING		26

#define	SND_COUNT		27

extern int sfx_loaded(int index);
