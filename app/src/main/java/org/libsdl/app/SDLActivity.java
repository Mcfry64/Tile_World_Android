...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* Set fullscreen immersive mode immediately in onCreate so the
         * window is at full display size before SDL creates its surface.
         * This also prevents GammaOS's game launcher overlay from
         * appearing and destroying the surface during initialisation. */
...
*/
    ...
    public static boolean handleKeyEvent(View v, int keyCode, KeyEvent event, InputConnection ic) {
        ...
        if (event.getAction() == KeyEvent.ACTION_DOWN) {
            Log.v("SDL", "key down: " + keyCode + ", deviceId = " + deviceId + ", source = " + source + ", isJoy=" + SDLControllerManager.isDeviceSDLJoystick(deviceId));
        } else if (event.getAction() == KeyEvent.ACTION_UP) {
            Log.v("SDL", "key up: " + keyCode + ", deviceId = " + deviceId + ", source = " + source + ", isJoy=" + SDLControllerManager.isDeviceSDLJoystick(deviceId));
        }
